...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 29, 2022 lúc 02:15 PM
...
--
ALTER TABLE `product_color`
  MODIFY `id_pro_color` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT cho bảng `product_detail_img`
--
ALTER TABLE `product_detail_img`
  MODIFY `id_pro_detail_img` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT cho bảng `product_size`
--
ALTER TABLE `product_size`
  MODIFY `id_pro_size` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=81;
COMMIT;
